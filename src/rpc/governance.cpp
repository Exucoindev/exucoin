...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in exucoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("exucoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* EXUCOIN features */
    { "exucoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "exucoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "exucoin",               "gobject",                &gobject,                true,  {} },
    { "exucoin",               "voteraw",                &voteraw,                true,  {} },
