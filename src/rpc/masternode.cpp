...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print EXUCOIN address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "exucoin",               "masternode",             &masternode,             true,  {} },
    { "exucoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "exucoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "exucoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "exucoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "exucoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
