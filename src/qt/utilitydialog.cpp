    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  exucoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the EXUCOIN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EXU, 0.1 EXU, 1 EXU and 10 EXU -- sort of like the paper money you use every day.</li> \
