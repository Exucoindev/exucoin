    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EXU-light"), QVariant("light"));
    ui->theme->addItem(QString("EXU-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EXU-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("EXU-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("EXU-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EXU-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EXU-traditional"), QVariant("trad"));
