...
official/supported Docker Images found at https://hub.docker.com/r/exucoinpay/exucoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/exucoinpay/exucoind-develop/ when changing the above text**