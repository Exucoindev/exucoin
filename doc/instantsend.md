...
This mechanism has been integrated into Bitcore-Node-EXUCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/exucoinpay/insight-api-exucoin#web-socket-api](https://github.com/exucoinpay/insight-api-exucoin#web-socket-api)
* API: [https://github.com/exucoinpay/insight-api-exucoin#instantsend-transactions](https://github.com/exucoinpay/insight-api-exucoin#instantsend-transactions)
...
By default, the EXUCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EXUCOIN Core daemon:
