...
This document provides guidelines for internationalization of the EXUCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `exucoin_en.ts` remains unchanged.
